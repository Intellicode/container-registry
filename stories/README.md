...
This directory contains user stories derived from the [PRD](../PRD.md) for the Container Registry project.

## Story Index

### Phase 1: Core Registry (MVP)

These stories deliver the minimum viable product - basic push/pull functionality with Docker CLI.
...
2. **Sprint 2** (MVP Blob/Manifest):
   - Stories 006-011 (blob upload/download, manifest upload/download, tags, basic auth)
